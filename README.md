...
+ 为什么选择录用自己
    - 我对于 Rust 语言不敢说精通，但有自信可以达到熟悉的程度，这个在和我同年龄段的同学之间是比较罕见的。作为贵司产品 TiDB 的存储层 tikv, 是基于 Rust 语言开发的，我可以为 tikv 做优化，进而提高 TiDB 的性能。
    - 我对于计算机底层知识，特别是从处理核到 SoC 再到操作系统这块，是比较熟悉的。当 tikv 的算法优化达到一定瓶颈的时候，我可以尝试从更加底层的原理出发寻求优化方案。
    - 不仅仅局限于课本上的理论知识，拥有将理论转换为代码的能力。
+ 如何看待学历和能力
